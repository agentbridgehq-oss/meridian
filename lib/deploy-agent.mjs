...
const TEMPLATES = {
  voice: {
    ...
    humanTransfer: 'Owner mobile for emergencies',
    tone: 'professional',
  },
  sales: {
    primaryNeed: 'sales',
    ...
    humanTransfer: 'Sales owner for price negotiation',
    tone: 'warm',
  },
  booking: {
    primaryNeed: 'booking',
    ...
    humanTransfer: 'Front desk for complex reschedules',
    tone: 'professional',
  },
  full: {
    primaryNeed: 'full',
    ...
    humanTransfer: 'Main line for emergencies',
    tone: 'professional',
  },
};
